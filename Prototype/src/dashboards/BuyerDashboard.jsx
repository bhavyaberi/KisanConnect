...
export default function BuyerDashboard() {
  ...
  // Translate cropId -> the display name recharts' XAxis actually reads
  // (dataKey="crop"), so switching language relabels the bar chart too.
    ...
    <>
      ...
      <div className="flex flex-col gap-4 lg:flex-row">
        <div className="flex min-w-0 flex-1 flex-col rounded-2xl border border-stone-200 bg-white p-4 sm:p-5">
          ...
          <div className="mt-4 h-52 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={buyerSupplyForecast} margin={{ left: -20 }}>
                <defs>
        ...
        <div className="flex min-w-0 flex-1 flex-col rounded-2xl border border-stone-200 bg-white p-4 sm:p-5">
          ...
          <div className="mt-4 h-52 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={supplyByCrop} margin={{ left: -20 }}>
                <CartesianGrid vertical={false} stroke="#f1f1ea" />
      ...
      <div className="flex flex-col rounded-2xl border border-stone-200 bg-white p-4 sm:p-5">
        ...
        <div className="mt-4 h-56 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={buyerPriceHistory} margin={{ left: -20 }}>
              <CartesianGrid vertical={false} stroke="#f1f1ea" />
              <XAxis dataKey="day" tick={{ fontSize: 11, fill: "#a8a29e" }} axisLine={false} tickLine={false} />
              <YAxis tick={{ fontSize: 11, fill: "#a8a29e" }} axisLine={false} tickLine={false} />
              <Tooltip />
