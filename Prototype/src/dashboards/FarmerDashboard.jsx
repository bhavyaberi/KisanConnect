  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4 lg:flex-row">
        <div className="flex flex-col justify-center rounded-2xl border border-stone-200 bg-white p-4 sm:p-5 lg:w-72">
          ...
          <div className="mt-4">
            ...
            <p className="text-3xl font-bold text-stone-900">{farmerMarketInsight.currentPrice}</p>
          </div>

          <div className="mt-4 rounded-xl bg-emerald-50 p-3">
            <p className="text-xs text-emerald-700">{t("farmerDash.aiPredictedPrice")}</p>
            <div className="mt-1 flex items-center gap-1.5">
              <p className="text-lg font-bold text-emerald-800">{farmerMarketInsight.predictedRange}</p>
        ...
        <div className="flex min-w-0 flex-1 flex-col rounded-2xl border border-stone-200 bg-white p-4 sm:p-5">
          ...
          <div className="mt-4 h-56 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={farmerPriceForecast} margin={{ left: -20 }}>
      ...
      {farmerSurplusAlert.active && (
        <div className={`flex items-start gap-3 rounded-2xl border p-5 ${farmerSurplusAlert.severityColor}`}>
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm leading-relaxed">{t(farmerSurplusAlert.messageKey)}</p>
          </div>
        </div>
      )}
    </>
