      ...
      <div className="rounded-2xl border border-stone-200 bg-white p-5">
        <div className="divide-y divide-stone-100">
          {adminReports.map((r) => {
            ...
            return (
              <div key={r.id} className="flex items-center gap-4 py-3 first:pt-0">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 whitespace-nowrap rounded-lg border border-stone-200 px-3 py-1.5 text-xs font-medium text-stone-600 hover:bg-stone-50 disabled:opacity-60"
                >
                  {state === "ready" ? (
                    <>
